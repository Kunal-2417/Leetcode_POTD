...
public:
    ...
    int solve(string &s, int ind)
    {
        ...
        { // check if any of the chars can be skiped without any value returned
...
int main()
{
        vector<string> p = {"ox", "lb", "diz", "gu", "v", "ksv", "o", "nuq", "r", "txhe", "e", "wmo", "cehy", "tskz", "ds", "kzbu"};
        Solution s;
        cout << s.minExtraChar("dwmodizxvvbosxxw", p);
        return 0;
}